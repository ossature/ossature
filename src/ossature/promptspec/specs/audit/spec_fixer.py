...
_INSTRUCTIONS = """\
<instructions>
You will receive an audit finding with a location, issue description, and suggested fix. Your job is to edit the specification file to address the finding.
