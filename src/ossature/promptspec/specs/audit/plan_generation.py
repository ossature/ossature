...
- covers: for test tasks, the requirement heading text (or {#anchor} slugs) from the spec that the task's tests verify, so requirement coverage reporting counts them. Leave empty for non-test tasks.
